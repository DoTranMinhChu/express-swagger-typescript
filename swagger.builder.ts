import { ISwaggerInfo, ISwaggerExternalDocs } from "./iSwagger";
import * as assert from "assert";
import { SwaggerService } from "./swagger.service";
import { IApiOperationArgsBaseResponse } from "./iApiOperationArgs.base";
...
export interface ISwaggerBuildDefinition {
  ...
  /**
   * Define schemas.
   * Optional. Default is SwaggerDefinition.schemas = {}.
   */
  schemas?: {};
  /**
   * Define host.
...
export function build(buildDefinition: ISwaggerBuildDefinition): void {
  ...
  if (buildDefinition.components) {
    SwaggerService.getInstance().setComponents(buildDefinition.components);
  }
